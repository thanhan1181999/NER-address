...
# ================START ĐẦU TIÊN=====================
import pandas as pd 
names = ["address_parts.number","address_parts.street","parent.locality","parent.county","parent.region","parent.country","name.default"]
...
for index in range(len(data)):
  ...
  data['name.default'][index]         = data['name.default'][index].lower().replace(',',' ').replace('-',' ').replace('&',' ').replace('_',' ')
