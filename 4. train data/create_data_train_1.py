# ta sẽ tạo câu train bằng cách: với mỗi đối tượng được đặt tên ner
...
class ProcessData:
  ...
  def export(self):
    ...
    print("Có {} ner ".format(len(self.tokens)))
    print("location_ner_form có {len_sen} sentence".format(len_sen=len_sen))
